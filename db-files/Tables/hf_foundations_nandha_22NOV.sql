...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2022 at 11:45 AM
...
(1520, 'Hel', 'KIsoie', '24', '658844', '', 1, 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(1158, '8545441254', NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(1073, 'test@mail.com', NULL, NULL, NULL, NULL, 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(8, 1, 0, 'null', '1970-01-01', '00:00:00', '00:00:00', 0, 0, 0, '2022-11-22 02:07:24', '2022-11-22 02:07:24');
...
(0, 2888, 'HE', 'LO', NULL, 1158, 1520, 1073, 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(1, 1, '[\"4\"]', '[\"3\"]', 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
CREATE TABLE `rooms` (
  ...
  `max_capacity` tinyint(4) NOT NULL DEFAULT 0,
  `available_capacity` tinyint(4) NOT NULL DEFAULT 0,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `rooms` (`id`, `branch_id`, `room_name`, `room_type`, `max_capacity`, `available_capacity`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'X-A', 1, 10, 9, 1, '2022-08-06 13:10:43', '2022-08-06 13:10:43'),
(2, 1, 'V-B', 1, 12, 9, 0, '2022-11-22 02:34:13', '2022-11-22 02:42:01'),
(3, 1, 'III-A', 1, 15, 12, 1, '2022-11-22 02:35:56', '2022-11-22 02:41:59');
...
(1, 2888, 'Tango', 'M', 2, '2002-04-03', NULL, 1073, 1520, 1158, 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(1, 1, 'BA', 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(43105, 1, NULL, '2015', '84.52', 'First', 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(1, 1, 1, NULL, '1.5', 1, 'Teacher', NULL, 'Head Master', NULL, 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
(2888, 1, 0, 'hf-stf-0001', 'e10adc3949ba59abbe56e057f20f883e', 4, 'uploads/teacherData/Id_cards/Tango_2888.jpg', 1, '2022-11-22 05:04:19', '2022-11-22 05:04:19');
...
--
ALTER TABLE `contactdetails`
  MODIFY `condId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1159;
...
--
ALTER TABLE `emailaddresses`
  MODIFY `emlId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1074;
...
--
ALTER TABLE `orgstudents`
  MODIFY `orstId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `staffseduclgdetails`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43106;
...
--
ALTER TABLE `standard_subjects`
  MODIFY `std_subj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `studentsclasses`
  MODIFY `stuclId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `useragent_analytics`
  MODIFY `ua_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
