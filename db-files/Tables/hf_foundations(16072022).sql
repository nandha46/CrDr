...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 15, 2022 at 07:40 PM
...
(1, '175', 'Bharathipuram, Nagalnagar', 'Near school', 'Dindigul', '1', '624003', '', 1, 1, '2022-06-05 08:42:10', '2022-07-09 11:11:31'),
...
(1, '9042748542', '906346633', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '2022-06-05 08:42:10', '2022-07-09 11:11:31'),
...
(4, 'rharikumarcse@gmail.com', '', '', '', '', 0, '2022-06-05 08:42:10', '2022-07-09 11:11:31'),
(5, 'rharikumarcse@gmail.com', '', '', '', '', 0, '2022-06-08 00:09:19', '2022-06-08 00:09:19'),
(6, 'rharikumarcse@gmail.com', '', '', '', '', 0, '2022-06-08 00:34:40', '2022-06-08 00:34:40');
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `evntPlace` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `families` (
  ...
  `fmName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
(1, 1, '', '', 1, 4, 1, 0, '2022-06-05 08:42:10', '2022-06-05 08:42:10'),
(3, 3, NULL, '', 3, 6, 3, 0, '2022-06-08 00:34:40', '2022-06-08 00:34:40');
...
CREATE TABLE IF NOT EXISTS `lessons` (
  ...
  `lnMedMasterId` int NOT NULL,
  `lnSyMasterId` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  `menuurls` text CHARACTER SET utf8mb4,
...
(36, 'Topics', b'0', NULL, 3, 0, 'topics', 1, 8, 1, '2022-07-04 09:23:36', '2022-07-04 09:23:36');
...
DROP TABLE IF EXISTS `onlinetests`;
CREATE TABLE IF NOT EXISTS `onlinetests` (
  `id` int NOT NULL AUTO_INCREMENT,
  `question` varchar(2550) NOT NULL,
  `topicid` int NOT NULL,
  `questiontype` int NOT NULL,
  `choice` varchar(2550) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `orgholidays` (
  ...
  `hldName` varchar(30) NOT NULL,
  `hlddescription` varchar(100) NOT NULL,
  `hlddate` date NOT NULL,
  `hldmsg` varchar(100) NOT NULL,
...
(1, 1, 1, 0, '2022-06-05 08:42:10', '2022-06-05 08:42:10'),
(2, 1, 3, 0, '2022-06-08 00:34:40', '2022-06-08 00:34:40');
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  `stuMiddleName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
(1, 11, 'Harikumar', 'null', 'R', 1, '1995-02-01', 1, '2022-06-05 08:42:10', '2022-07-09 11:11:31'),
(2, 12, 'Test', 'null', 'test', 1, '2022-06-02', 1, '2022-06-08 00:09:19', '2022-06-08 00:09:19'),
(3, 13, 'test', 'null', 'demo', 1, '2022-06-02', 1, '2022-06-08 00:34:40', '2022-07-09 10:04:26');
...
(1, 1, 5, 1, '0000-00-00', 0, '2022-06-05 08:42:10', '2022-07-09 11:11:31'),
(2, 2, 4, 3, '0000-00-00', 0, '2022-06-08 00:34:40', '2022-06-08 00:34:40');
...
CREATE TABLE IF NOT EXISTS `subjects` (
  ...
  `standardid` int NOT NULL COMMENT 'aka ClssId',
...
(1, 'Tamil', 0, 1, '2022-04-24 13:35:59', '2022-04-24 13:35:59'),
(2, 'English', 0, 1, '2022-04-24 13:35:59', '2022-04-24 13:35:59'),
(3, 'Maths', 0, 1, '2022-04-24 13:37:17', '2022-04-24 13:37:17'),
(4, 'Science', 0, 1, '2022-04-24 13:37:17', '2022-04-24 13:37:17'),
(5, 'Social Science', 0, 1, '2022-04-24 13:37:17', '2022-04-24 13:37:17');
...
(1, 'Term I', 1, '2022-05-14 19:03:21', '2022-05-14 19:03:21'),
(2, 'Term II', 1, '2022-05-14 19:03:21', '2022-05-14 19:03:21'),
(3, 'Term III', 1, '2022-05-14 19:03:51', '2022-05-14 19:03:51');
...
(11, 0, 'hf-stu-0001', 'e10adc3949ba59abbe56e057f20f883e', 3, 1, '2022-06-05 08:42:10', '2022-06-05 08:42:10'),
(13, 0, 'hf-stu-0002', 'e10adc3949ba59abbe56e057f20f883e', 3, 1, '2022-06-08 00:34:40', '2022-06-08 00:34:40');
...
(1, 'Lorem ipsum', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit', 'https://loremipsum.io/', 'http://localhost/hopefoundation', 0, '2022-07-12 12:07:06', '2022-07-12 12:25:03'),
(2, 'Lorem ipsum dolor', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit', 'https://loremipsum.io/', 'http://localhost/hopefoundation', 1, '2022-07-12 12:08:43', '2022-07-12 12:25:11');
...
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `view_onlinetests`;
CREATE TABLE IF NOT EXISTS `view_onlinetests` (
`answer` varchar(2550)
,`choice` varchar(2550)
